            ...
            <div class="topbar__container container">
              <div class="topbar__row">
                <div class="topbar__item topbar__item--link">
                  <a class="topbar-link" href="javascript:void(0)">About Us</a>
                </div>
                <div class="topbar__item topbar__item--link">
                  <a class="topbar-link" href="javascript:void(0)">Contacts</a>
                </div>
                <div class="topbar__item topbar__item--link">
                  <a class="topbar-link" href="javascript:void(0)">Store Location</a>
                </div>
                <div class="topbar__item topbar__item--link">
                  <a class="topbar-link" href="javascript:void(0)">Track Order</a>
                </div>
                <div class="topbar__item topbar__item--link">
                  <a class="topbar-link" href="javascript:void(0)">Blog</a>
                </div>
                ...
                <div class="nav-panel__row">
                  ...
                  <div class="nav-panel__nav-links nav-links">
                    <ul class="nav-links__list">
                      ...
                      <li class="nav-links__item">
                        <a href="contact-us.html"><span>Camera</span></a>
                      </li>
                      <li class="nav-links__item">
                    ...
                    <div class="indicator indicator--trigger--click">
                      <a href="" class="indicator__button">
                        <span class="indicator__area">
                          ...
                          <span class="{{(Session::has('cart')) ? "indicator__value" : ""}}">
                          ...
                          <div class="dropcart__products-list">
                            ...
                            @foreach (Session::get('cart')->items as $product)
                              <div class="dropcart__product">
                                <div class="dropcart__product-image">
                                  <a href=""
                                    ><img
                                      src="{{asset('storage/products/'.$product['item']['main_thumbnail'])}}"
                                      alt=""
                                  /></a>
                                </div>
                                <div class="dropcart__product-info">
                                  <div class="dropcart__product-name">
                                    <p>{{mb_strimwidth($product["item"]["product_name"], 0, 30, "...")}}</p>
                                  </div>
                                  <div class="dropcart__product-meta">
                                    <span class="dropcart__product-quantity">{{$product['qty']}}</span>
                                    x
                                    <span class="dropcart__product-price">${{$product['item']['price']}}</span>
                                  </div>
                                </div>
                                <button
                                  type="button"
                                  class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon item_delete"
                            ...
                            <div class="dropcart__totals">
                              ...
                              <div class="dropcart__buttons">
                                <a class="btn btn-secondary" href="{{route("shopping.cart")}}"
                                  >View Cart</a
                                >
                            ...
                            @else
                              <p class="text-center">
                                <strong class="text-secondary">Your cart is empty!!!</strong>
                              </p>
                            @endif
                          </div>
                        </div>
