...
@section('content')
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-card__image">
                              <a href="{{route('view.product', $item->slug)}}">
                                <img src="{{asset('storage/products/'.$item->main_thumbnail)}}" alt=""/>
                              </a>
                            </div>
                            <div class="product-card__info">
                              <div class="product-card__name">
                                  <a href="">{{mb_strimwidth($item->product_name, 0, 18, "...")}}</a>
                              </div>
                            ...
                            <div class="product-card__actions">
                              <div class="product-card__prices">${{$item->price}}</div>
                                <div class="product-card__buttons">
                                    <a href="{{($item->status)? route('product.addToCart', $item->id) : "javascript:void(0)"}}" class="btn btn-primary product-card__addtocart" type="button">
                                      Add To Cart
                                    </a>
    ...
    <div class="block block-banner">
        ...
        <a href="#" class="block-banner__body"
            ...
            style="background-image: url('{{asset('FrontAssets/images/banners/banner-1.jpg')}}');"
            ></div>
            <div
            class="block-banner__image block-banner__image--mobile"
            style="
                background-image: url('{{asset('FrontAssets/images/banners/banner-1-mobile.jpg')}}');
            "
            ></div>
                ...
                <div class="block-products-carousel__column">
                  <div class="block-products-carousel__cell">
                    <div class="product-card">
                      ...
                      <div class="product-card__image">
                        <a href="{{route('view.product', $featured_item->slug)}}">
                          <img src="{{asset('storage/products/'.$featured_item->main_thumbnail)}}" alt=""/>
                        </a>
                      </div>
                      <div class="product-card__info">
                        <div class="product-card__name">
                          <a href="{{route('view.product', $featured_item->slug)}}"
                            >{{mb_strimwidth($featured_item->product_name, 0, 18, "...")}}</a
                          >
                        </div>
                        <div class="product-card__rating">
                          <i class="fas fa-star text-warning"></i>
                      ...
                      <div class="product-card__actions">
                        ...
                        <div class="product-card__prices">${{$featured_item->price}}</div>
                        <div class="product-card__buttons">
                          <a href="{{($featured_item->status)? route('product.addToCart', $featured_item->id) : "javascript:void(0)"}}"
                            class="btn btn-primary product-card__addtocart"
                            type="button"
                          >
                            Add To Cart
